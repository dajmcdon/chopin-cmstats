...
<div class="my-footer"><span><a href="https://dajmcdon.github.io/chopin-talk" style="color:white">dajmcdon.github.io/chopin-talk</a></span></div> 
...
ttt %>%  ggplot(aes(x=value,fill=clust)) +
  ...
  th + 
  scale_x_continuous(breaks=scales::pretty_breaks(3), expand=expansion(c(0,.05)))+
  scale_y_continuous(expand = expansion(c(0,0.05)))+
